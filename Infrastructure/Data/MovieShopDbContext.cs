...
public class MovieShopDbContext : DbContext
{
    ...
    public DbSet<Movie> Movies { get; set; }  //Movies table access
    ...
    private void ConfigureCast(EntityTypeBuilder<Cast> builder)
    {
        ...
        builder.Property(c => c.TmdbUrl).HasMaxLength(2048);
    }


    private void ConfigureMovieGenre(EntityTypeBuilder<MovieGenre> builder)
    {
        builder.ToTable("MovieGenres"); // specify table name (Fluent API)
    ...
    private void ConfigureMovie(EntityTypeBuilder<Movie> builder)
    {
        ...
        builder.HasKey(m => m.Id); // HasKey means for PK, for this we don't have to do this but get idea
